...
goals = [12,35,7]
colors = ['y','r','b']
plt.pie(goals,labels=goal_types,colors=colors,shadow=True,explode=(0.05,0.05,0.05), autopct="%1.1f%%")   # gölgelendirme, pastalar arası mesafe ve yüzdelik değerler de eklendi.
